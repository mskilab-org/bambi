...
bam_path = "/gpfs/commons/home/biederstedte-934/data/Maciejowski2015/10x/IMI-3-10X-chromium/PHASER_SVCALLER_CS/PHASER_SVCALLER/ATTACH_PHASING/fork0/files/phased_possorted_bam.bam"

bxbam_name = "IMI-3-10X-chromium_phased_possorted_bam5.h5"
...
for i, line in enumerate(l.decode(errors='ignore') for l in task.stdout):  # decode binary
    ...
    store.append(hdf_key, dicts_into_df,  data_columns=bxbam_columns, index=False, min_itemsize={'BX':175, 'QNAME':275, 'QUAL':575, 'CIGAR':100, 'RNAME':100, 'RNEXT':50, 'SEQ':575})
